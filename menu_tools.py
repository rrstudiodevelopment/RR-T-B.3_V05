...
class RAHA_OT_InfoPopup(bpy.types.Operator):
    ...
    def execute(self, context):
        def draw_popup(self, context):
            ...
            col = layout.column()
            col.label(text="update 19/03/2025 - 20:45")
            col.label(text="Raha Tools v.05 on blender 3+")            
            col.separator()            
            col.label(text="- Thank you for using Raha Tools for Blender 3+. ")
            col.label(text="- We regret to inform you that development")
            col.label(text="- for Raha Tools on Blender 3+ has been discontinued.")
            col.label(text="- Moving forward,our focus will be")
#            col.separator()
            col.label(text="- on developing Raha Tools for Blender 4+.")
